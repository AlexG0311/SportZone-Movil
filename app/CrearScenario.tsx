    ...
    const buscarDireccion = async () => {
        ...
        try {
            ...
            if (geocode.length > 0) {
                ...
                Alert.alert('Error', 'No se encontraron coordenadas para esta dirección');
            }
        } catch (error) {
    ...
    const enviarFormulario = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                Alert.alert('Error', errorData.message || 'No se pudo crear el escenario');
            }
        } catch (error) {
            ...
            <View style={styles.form}>
                ...
                <View style={styles.coordSection}>
                    ...
                    <View style={styles.coordButtons}>
                        <Pressable style={styles.coordButton} onPress={obtenerUbicacionActual}>
                ...
                <View style={styles.fieldContainer}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setFormData(prev => ({ ...prev, capacidad: text }))}
                        ...
                        <View style={styles.imageContainer}>
                            ...
                            {isUploading && (
                                <View style={styles.uploadingOverlay}>
                                    <Text style={styles.uploadingText}>Subiendo a Cloudinary...</Text>
                                </View>
                            )}
                            ...
                            {formData.imagenUrl && (
                                <View style={styles.cloudinaryInfo}>
                                    <Text style={styles.cloudinaryText}>
                                         Imagen cargada
                                    </Text>
                                </View>
                            )}
                ...
                <View style={styles.fieldContainer}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setFormData(prev => ({ ...prev, estadoId: parseInt(text) || 1 }))}
                        placeholder="1"
                        keyboardType="numeric"
                    />
                </View>
                ...
                {/* Botón Enviar */}
                <Pressable 
                    style={[styles.submitButton, (isUploading || !formData.imagenUrl) && styles.submitButtonDisabled]} 
