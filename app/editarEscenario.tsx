    ...
    const cargarDatosEscenario = async () => {
        try {
            ...
            if (response.ok) {
                ...
                const latitud = escenario.latitud ? parseFloat(escenario.latitud) : null;
                const longitud = escenario.longitud ? parseFloat(escenario.longitud) : null;
    ...
    const actualizarEscenario = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                Alert.alert('Error', responseData.error || responseData.message || 'No se pudo actualizar el escenario');
            }
        } catch (error) {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.form}>
                ...
                <View style={styles.fieldContainer}>
                    ...
                    <View style={styles.pickerContainer}>
                        <Picker
                            ...
                            onValueChange={(itemValue) => setFormData(prev => ({ ...prev, tipo: itemValue }))}
                            style={styles.picker}
                        >
              ...
              <TouchableOpacity style={styles.locationButton} onPress={obtenerCoordenadas}>
                  <Text style={styles.locationButtonText}>
                      {(formData.latitud !== null && formData.longitud !== null && 
                        typeof formData.latitud === 'number' && typeof formData.longitud === 'number')
